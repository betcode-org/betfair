...
LOGIN_EXCEPTIONS = {'INVALID_USERNAME_OR_PASSWORD': "The username or password are invalid",
...
GENERIC_JSON_RPC_EXCEPTIONS = {-32700: 'Invalid JSON was received by the server. An error occurred on the server while parsing the JSON text.',
                               -32601: 'Method not found',
                               -32602: 'Problem parsing the parameters, or a mandatory parameter was not found',
                               -32603: 'Internal JSON-RPC error'}
# Betting
APING_EXCEPTION = {'TOO_MUCH_DATA': "The operation requested too much data, exceeding the Market Data Request Limits.",
...
MARKET_STATUS = {"INACTIVE": "The market has been created but isn't yet available.",
...
INSTRUCTION_REPORT_STATUS = {'SUCCESS': '',
                             'FAILURE': '',
                             'TIMEOUT': ''}

INSTRUCTION_REPORT_ERROR_CODE = {"INVALID_BET_SIZE": "bet size is invalid for your currency or your regulator",
...
EXECUTION_REPORT_STATUS = {"SUCCESS": "Order processed successfully",
...
EXECUTION_REPORT_ERROR_CODE = {"ERROR_IN_MATCHER": "The matcher is not healthy",
