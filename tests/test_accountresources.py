...
class AccountTest(unittest.TestCase):
    ...
    def test_legacy_data(self):
        bet_result = {'avgPrice': 13.5, 'betSize': 13.63, 'betType': 'B', 'betCategoryType': 'E', 'eventId': 184661684,
                      'eventTypeId': 7, 'fullMarketName': 'GB / Bath 23rd Jun/ 20:50 1m2f Hcap', 'grossBetAmount': 0.0,
                      'marketName': '1m2f Hcap', 'marketType': 'O', 'placedDate': '2021-06-23T19:44:29.000Z',
                      'selectionId': 25204971, 'selectionName': 'Volcano Bay', 'startDate': '2021-06-23T19:50:00.000Z',
                      'transactionType': 'ACCOUNT_DEBIT', 'transactionId': 0, 'winLose': 'RESULT_LOST',
                      'avgPriceRaw': 13.5}

        resource = resources.LegacyData(
            **bet_result
        )
        assert isinstance(resource, resources.LegacyData)
        # exchange sub account trans
        exchange_transfer = {'avgPrice': 0.0, 'betSize': 0.0, 'betType': 'B', 'betCategoryType': 'E', 'eventId': 0,
                             'eventTypeId': 0, 'fullMarketName': 'Cross accounts transfer', 'grossBetAmount': 0.0,
                             'marketType': 'NOT_APPLICABLE', 'placedDate': '2021-06-16T07:47:10.000Z',
                             'selectionId': 0, 'startDate': '0001-01-01T00:00:00.000Z',
                             'transactionType': 'ACCOUNT_DEBIT', 'transactionId': 0,
                             'winLose': 'RESULT_NOT_APPLICABLE', 'avgPriceRaw': 0.0}
        ...
        account_debit = {'avgPrice': 0.0, 'betSize': 0.0, 'betType': 'B', 'betCategoryType': 'NONE',
                         'commissionRate': '2%',
                         'eventId': 184661684, 'eventTypeId': 7,
                         'fullMarketName': 'GB / Bath 23rd Jun/ 20:50 1m2f Hcap',
                         'grossBetAmount': 1968.17, 'marketName': '1m2f Hcap', 'marketType': 'O',
                         'placedDate': '2021-06-23T19:46:12.000Z', 'selectionId': 0,
                         'startDate': '2021-06-23T19:50:00.000Z',
                         'transactionType': 'ACCOUNT_DEBIT', 'transactionId': 0, 'winLose': 'RESULT_NOT_APPLICABLE',
                         'avgPriceRaw': 0.0}
